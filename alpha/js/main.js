...
(function () {
  ...
  // Stat counters
  document.querySelectorAll('.statbar__num').forEach(function (el) {
  ...
  // Parallax on hero + pillar media
  document.querySelectorAll('.hero__media img, .pillar__media img').forEach(function (img) {
    gsap.to(img, {
      yPercent: -10, ease: 'none',
      scrollTrigger: { trigger: img.closest('.hero, .pillar'), start: 'top bottom', end: 'bottom top', scrub: true }
    });
  });
